...
const standaloneBaseConfig = {
  ...
  output: {
    file: 'dist/react-onload-iframe.js',
    format: 'umd',
    globals,
...
const standaloneProdConfig = {
  ...
  output: {
    ...
    file: 'dist/react-onload-iframe.min.js',
  },
  plugins: standaloneBaseConfig.plugins.concat(
    replace({
...
const serverConfig = {
  ...configBase,
  output: [
    getESM({ file: 'dist/react-onload-iframe.esm.js' }),
    getCJS({ file: 'dist/react-onload-iframe.cjs.js' }),
  ],
  plugins: configBase.plugins.concat(
    replace({
      window: undefined,
...
const browserConfig = {
  ...configBase,
  output: [
    getESM({ file: 'dist/react-onload-iframe.browser.esm.js' }),
    getCJS({ file: 'dist/react-onload-iframe.browser.cjs.js' }),
  ],
  plugins: configBase.plugins.concat(
    replace({
      __SERVER__: JSON.stringify(false),
